...
/**
 * Sanity Test for {@link AzureBlobWriter}.
 */
public class AzureBlobWriterTest {

    @Test
    public void initTest() throws IOException {
        Map<String, Object> config = new HashMap<>();
        config.put("provider", PROVIDER_AZURE);
        config.put("azureStorageAccountName", "azureName");
        config.put("azureStorageAccountKey", "azureKey");
        config.put("bucket", "test");
        config.put("endpoint", "https://justatest.blob.core.windows.net/");
        ...
        AzureBlobWriter writer = new AzureBlobWriter(cloudStorageSinkConfig);
        writer.close();
    }
}
